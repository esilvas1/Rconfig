...
## 2) Conclusiones del EDA (student_mat)

Los datos de student_mat no requieren imputación: el dataset se encuentra limpio, sin valores faltantes relevantes y los valores extremos detectados son calificaciones plausibles dentro del rango 0–20 (no errores de entrada). Por tanto, se considera la muestra válida y lista para proceder con un modelo de regresión lineal simple.

## 3) Resumen numérico: missing, Outlier and Correlation (student_por)
